...
public class GameController: MonoBehaviour {
  ...
  void Start () {
    ...
    hero1Instance.AddComponent<HeroObject>().createHero(0.64f, 1.92f, "Knight", "Solaire", 2, 1200, "bouette");
    ...
    hero2Instance.AddComponent<HeroObject>().createHero(-1.92f, 1.92f, "Wizard", "Gandalf", 1, 200, "celeste128");
